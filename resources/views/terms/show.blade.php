                ...
                <div class="card-body">
                        ...
                        <div class="row d-flex ">
                            <div class="col-md-6 mb-2">
                                ...
                                <input id="name" type="text"
                                    ...
                                    value="{{ $term->name }}" required disabled autocomplete="name">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                                    name="description" value="{{ old('description') }}" disabled autocomplete="description" autofocus>{{ $term->description }}</textarea>
                    ...
                    <div class="col-md-5 d-block">
                        ...
                        @include('components.delete_modal', [
                            'delete_route' => route('term.destroy', $term->id),
                            'warning_message' => 'هل انت متأكد من رغبتك بحذف الشرط ' . $term->name,
                        ])
                        <a href="{{ route('term.index') }}" class="btn btn-primary">الرجوع
                            للصفحة الرئيسية </a>
                    </div>
                    <br><br><br>
                </div>
