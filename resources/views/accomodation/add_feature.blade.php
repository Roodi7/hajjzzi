...
@section('title', 'إضافة ميزة/ملحق للمسكن')
@section('content')
                ...
                <div class="card-body">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-center">
                                            <form action="{{ route('accommodation.add_feature_post', $accommodation->id) }}"
                    ...
                    <div class="table-responsive  mt-4">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                @forelse ($accommodationFeatures as $accommodationFeature)
                                    <tr>
                                        {{-- @dd($accommodationFeature) --}}
                                        <th class="text-center align-middle" scope="row">{{ $accommodationFeature->id }}
                                        </th>
                                        <td class="text-center align-middle">{{ $accommodationFeature->name }}</td>

                                        <td class="text-center align-middle">{{ $accommodationFeature->description }}</td>


                                        <td class="d-flex justify-content-center gap-1">
                                            <form
                                                action="{{ route('accommodation.delete_feature', $accommodationFeature->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
