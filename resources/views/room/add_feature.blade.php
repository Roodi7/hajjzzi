...
@section('title', 'إضافة ميزة للغرفة')
@section('content')
                ...
                <div class="card-body">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-center">
                                            <form action="{{ route('room.add_feature_post', $room->id) }}"
                    ...
                    <div class="table-responsive  mt-4">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                @forelse ($roomFeatures as $roomFeature)
                                    <tr>
                                        {{-- @dd($roomFeature) --}}
                                        <th class="text-center align-middle" scope="row">{{ $roomFeature->id }}
                                        </th>
                                        <td class="text-center align-middle">{{ $roomFeature->name }}</td>

                                        <td class="text-center align-middle">{{ $roomFeature->description }}</td>


                                        <td class="d-flex justify-content-center gap-1">
                                            <form action="{{ route('room.delete_feature', $roomFeature->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
