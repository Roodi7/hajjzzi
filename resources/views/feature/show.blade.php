                ...
                <div class="card-body">
                        ...
                        <div class="row d-flex ">
                            <div class="col-md-6 mb-2">
                                ...
                                <input id="name" type="text"
                                    ...
                                    value="{{ $feature->name }}" required  disabled autocomplete="name">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input id="rating" type="text"
                                    ...
                                    value="{{ $feature->rating }}"  disabled autocomplete="rating" autofocus>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                                    name="description" value="{{ old('description') }}"  disabled autocomplete="description" autofocus>{{ $feature->description }}</textarea>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea id="notes" type="text" class="form-control @error('notes') is-invalid @enderror" name="notes"
                                    value="{{ old('notes') }}"  disabled autocomplete="notes" autofocus>{{ $feature->notes }}</textarea>
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input id="images" type="file" multiple
                                    ...
                                    value="{{ old('images') }}"  disabled autocomplete="images" autofocus>
                    ...
                    <div class="col-md-5 d-block">
                        ...
                        @include('components.delete_modal', [
                            'delete_route' => route('feature.destroy', $feature->id),
                            'warning_message' => 'هل انت متأكد من رغبتك بحذف الميزة ' . $feature->name,
                        ])
                        <a href="{{ route('feature.index') }}" class="btn btn-primary">الرجوع
                            للصفحة الرئيسية </a>
                    </div>
                    <br><br><br>
                </div>
