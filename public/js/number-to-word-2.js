        ...
        if (Scale) {
            ...
            if (Num_99 > 2) {
                ...
                if (!Num_99) Words999 += " " + Scale; // Scale for 0
                    ...
                    Words999 =
                        Word_100Wa +
                        (IsLastEffTriplet && TextToFollow ? Aa : Aan); // Scale for 2 ألفا or ألفان
            }
        }
...
function NumberToWord() {
    ...
    document.getElementById("amount_in_writing").value = nArabicWords(amount);
    // alert(number);
}
