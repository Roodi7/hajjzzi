@extends('layouts.app', [
    'navlinks' => [['title' => 'الرئيسية', 'link' => route('home')], ['title' => 'شروط الخدمة', 'link' => route('privacy-policy.index')]],
])
@section('title', 'إدارة شروط الخدمة ')
@section('content')
                    ...
                    <h4 class="card-title d-flex justify-content-between mb-4">
                        ...
                        <div class="col-md-3 text-end" style="float:left">
                            <a class="btn btn-primary waves-effect waves-light"
                                href="{{ route('privacy-policy.index') }}"><i
                                ...
                                @forelse ($items as $item)
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            ...
                                            <form action="{{ route('privacy-policy.destroy', $item->id) }}" method="POST"
